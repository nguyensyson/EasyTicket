...
- Chưa có Dockerfile hay Kubernetes manifest nào trong repo – `docker-compose.yml` ở root hiện chỉ chạy hạ tầng phụ trợ local (MySQL, Redis, Kafka, Keycloak, ELK, OTel Collector), không phải deployment của service.
